...
if __name__ == "__main__":
    ...
    source_color = read_image(image_dirs + "/color/10.jpg")
    source_depth = read_image(image_dirs + "/depth/10.png")

    target_color = read_image(image_dirs + "/color/11.jpg")
    target_depth = read_image(image_dirs + "/depth/11.png")
